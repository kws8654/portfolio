...
export const OpenedDocFolder = forwardRef((props: OpenedDocFolderProps, ref: ForwardedRef<any>) => {
  ...
  return (
    <div
      ref={ref}
      className={`absolute top-[200px] left-[350px] w-[720px] h-[415px] border border-gray-300 rounded-lg bg-neutral-100 styles-text-xs overflow-hidden hover:z-40 ${
              ...
              <div key={`document-${index}`} className='flex flex-col items-center'>
                <Image
                  ...
                  className={`${
                    ...
                    'border bg-gray-500/50 rounded-md'
                  }`}
